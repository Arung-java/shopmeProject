...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/users/**", "/settings/**", "/countries/**", "/states/**")
				.hasAuthority("Admin").antMatchers("/catagories/**", "/brands/**").hasAnyAuthority("Admin", "Editor")
				...
				.permitAll().and().logout().permitAll().and().rememberMe().key("AbcDefghIfKlmnoP_123456789")
				.tokenValiditySeconds(7 * 24 * 60 * 60).and().sessionManagement()
