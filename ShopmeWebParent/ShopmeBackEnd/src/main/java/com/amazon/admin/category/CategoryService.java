...
public class CategoryService {
	...
	public List<Category> listByPage(CategoryPageInfo pageInfo, int pageNum, String sortDir,String keyword) {
		...
		System.out.println("rootCategories : :" + rootCategories);
		if(keyword!=null && !keyword.isEmpty()) {
	...
	private List<Category> listHierarchicalCategories(List<Category> rootCategories, String sortDir) {
		...
		System.out.println("hierarchicalCategories ===" + hierarchicalCategories);
	...
	public void delete(Integer id) throws UserNotFoundException, CategoryNotFoundException {
		Long countById = repository.countById(id);// with help of this we can get id not whole object.
