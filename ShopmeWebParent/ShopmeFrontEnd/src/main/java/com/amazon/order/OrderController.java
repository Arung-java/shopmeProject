...
public class OrderController {
	 ...
	 * 
	 * while(iterator.hasNext()) { OrderDetail orderDetail = iterator.next();
	 * Product product = orderDetail.getProduct(); Integer productId =
	 * product.getId();
	 * 
	 * boolean didCustomerReviewProduct =
	 * reviewService.didCustomerReviewProduct(customer, productId);
	 * product.setReviewedByCustomer(didCustomerReviewProduct);
	 * 
	 * if (!didCustomerReviewProduct) { boolean canCustomerReviewProduct =
	 * reviewService.canCustomerReviewProduct(customer, productId);
