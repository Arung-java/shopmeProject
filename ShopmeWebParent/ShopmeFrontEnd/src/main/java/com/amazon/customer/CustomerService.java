...
import com.amazon.setting.CountryRepository;
...
public class CustomerService {
	...
	public void updateAuthentiationType(Customer customer, AuthenticationType type) {
	...
	public String updateResetPasswordToken(String email) throws CustomerNotFoundException {
		...
		if (customer != null) {
			...
			throw new CustomerNotFoundException("Could not found any customer with the email " + email);
		}
	}
