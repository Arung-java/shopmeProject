decimailSeparator = decimalPointType == 'COMMA' ? ',' : '.';
...
function formatCurrency(amount) {
	...
	return $.number(amount, decimalDigits, decimailSeparator, thousandSeparator);
}
function clearCurrencyFormat(numberString) {
	result = numberString.replaceAll(thousandSeparator, "");
	return result.replaceAll(decimailSeparator, ".");
}
